#ifndef UMLPROJECT_SRC_HEADER_COMMANDEMACRO_COMMANDEAPPELER_H_
#define UMLPROJECT_SRC_HEADER_COMMANDEMACRO_COMMANDEAPPELER_H_
...
#endif /* UMLPROJECT_SRC_HEADER_COMMANDEMACRO_COMMANDEAPPELER_H_ */
