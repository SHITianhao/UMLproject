#ifndef UMLPROJECT_SRC_HEADER_COMMANDEMACRO_COMMANDEDEFMACRO_H_
#define UMLPROJECT_SRC_HEADER_COMMANDEMACRO_COMMANDEDEFMACRO_H_
...
#endif /* UMLPROJECT_SRC_HEADER_COMMANDEMACRO_COMMANDEDEFMACRO_H_ */
