...
void Observateur::afficher(Observable* o, const std::string commande) {
	Robot* robot = (Robot*) o;
	cout << "<------------ Commande " << cpt << " ------------>" << "\n";
	cout << "|  Requete : " << commande << "\n";
	cout << "|  Etat : " << robot->getEtat()->getEtatToString() << "\n";
	cout << "|  Position : " << robot->getPosition().getX() << ", "
...
void Observateur::afficherException(Observable* o, const std::string commande,
